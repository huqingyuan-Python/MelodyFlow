...
1. 下载并解压 `MelodyFlow-Online.zip`
2. 双击运行 `启动服务.bat`
3. 浏览器打开 http://127.0.0.1:9763
4. 在设置页面配置音源地址（默认已配置）
5. 开始搜索在线音乐！

> ⚠️ 需要安装 Node.js：https://nodejs.org/
